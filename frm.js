  ...
  layers: [
    {
      ...
      ao: 0,
      ks: {
        a: { a: 0, k: [297.587, 298.119, 0], ix: 1 },
        s: { a: 0, k: [100, 100, 100], ix: 6 },
        sk: { a: 0, k: 0 },
        p: { a: 0, k: [259.587, 260.119, 0], ix: 2 },
        sa: { a: 0, k: 0 },
        o: {
          a: 1,
          k: [
            { o: { x: 0.333, y: 0 }, i: { x: 0.667, y: 1 }, s: [100], t: 50 },
            {
              o: { x: 0.167, y: 0.167 },
              i: { x: 0.833, y: 0.833 },
              s: [0],
      ...
      shapes: [
        ...
        },
        {
          ...
          s: {
            a: 1,
            k: [
              { o: { x: 0.333, y: 0 }, i: { x: 0, y: 1 }, s: [100], t: 24 },
              {
                o: { x: 0.167, y: 0.167 },
                i: { x: 0.833, y: 0.833 },
                s: [0],
      ...
      shapes: [
        {
          ...
          it: [
            ...
            },
            {
              ...
              w: { a: 0, k: 10, ix: 5 },
              d: [],
              c: { a: 0, k: [0.0706, 0.0706, 0.0706], ix: 3 },
            },
            {
              ty: "fl",
              bm: 0,
              ...
              nm: "Fill 1",
              c: { a: 0, k: [0.0706, 0.0706, 0.0706], ix: 4 },
              r: 1,
              o: {
                a: 1,
                k: [
                  { o: { x: 0.333, y: 0 }, i: { x: 0, y: 1 }, s: [0], t: 22 },
                  {
                    o: { x: 0.167, y: 0.167 },
                    i: { x: 0.833, y: 0.833 },
                    s: [100],
      ...
      if (!pincodePattern.test(pincode)) {
        ...
        if (validateCode(formObject.city, pincode)) {
          ...
          if (flag) {
            setError(
              pincodeInput,
              "Oops! Looks like your area is not covered."
            );
          } else {
...
function Step3(bill, price) {
  ...
  document
    .querySelector(".step-3 > .form-group>#date")
  ...
  Array.from(document.querySelectorAll(".innerDiv")).map((vl) => {
    vl.addEventListener(
      ...
      (e) => {
        innerDivState();
        if (
          e.target.className === "wrapSecond" ||
          e.target.className === "wrapFirst"
        ) {
        ...
        if (
          document
            ...
            .classList.contains("activeSection")
        ) {
          ...
          document.getElementById("btn3").addEventListener("click", () => {
            ...
            if (userorder.service === "General Service")
              userorder.amount = 1099;
  ...
  if (document.querySelector(".section3").classList.contains("activeSection")) {
    ...
    document.getElementById("btn2").onclick = (e) => {
      ...
      if (
        ...
        slot &&
        address &&
        document.getElementById("defaultCheck1").checked
      ) {
        //console.log("hi");
